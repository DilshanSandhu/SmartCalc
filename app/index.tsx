  ...
  const handleEqual = async () => {
    try {
      ...
      if (input.includes("+")) {
        ...
        calculatedResult = Number(parts[0]) + Number(parts[1]);
    ...
    <View style={styles.container}>
      ...
      {showMenu && (
        <View style={styles.popupMenu}>
          ...
          >
            <Text style={styles.popupItem}>Basic</Text>
          </TouchableOpacity>
          ...
          >
            <Text style={styles.popupItem}>Scientific</Text>
          </TouchableOpacity>
          ...
          >
            <Text style={styles.popupItem}>Convert</Text>
          </TouchableOpacity>
          ...
          >
            <Text style={styles.popupItem}>Graph</Text>
          </TouchableOpacity>
        </View>
      )}
